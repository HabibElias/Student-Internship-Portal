...
$applications = $db->query('SELECT a.id, a.job_id, a.student_id, c.company_name, a.cv, a.recommendation_letter, a.status from applications a join companies c on a.company_id = c.user_id where student_id = :id and status = failed', [
    'id' => $user_id
])->get();
