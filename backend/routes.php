...
$router->get('/company', '/company/index.php')->only('auth');

$router->patch('/company', '/company/patch.php')->only('auth');

// student profile

$router->get('/student/profile', '/student/index.php')->only('auth');

$router->patch('/student/profile', '/student/patch.php')->only('auth');
